...
import styles from '../../styles/footer/Footer.css'

const SocialNetworkButton = ({href, text, children }) => {
  return (
...
const FooterContacts = ({ type }) => {
  return(
    <p className={ `footer-contacts ${ type }` }>
...
function Footer() {
  return (
    <footer className='main-footer'>
      ...
      <FooterContacts type={ 'start' }/>
        <div className='footer-social'>
          <ul>
            <SocialNetworkButton text='Linkedin' href='#'>
            ...
            <SocialNetworkButton text='Facebook' href={'#'}>
              <svg xmlns="http://www.w3.org/2000/svg" className='icon' viewBox="0 0 10.15 21.74">
            ...
            <SocialNetworkButton text='GitHub' href={'#'}>
            <svg xmlns="http://www.w3.org/2000/svg" className='icon' viewBox="0 0 448 512">
